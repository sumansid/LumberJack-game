...
$("#ball").click(function(){
  ...
  for (i = 1; i <= 3; i++) {
    ...
    //margin-top: 190px;
    $('#TREES').prepend('<img class="tree" src="asserts/img/tree.jpg"'+id+' style="margin-top:'+TreeTopPosition+'px;margin-left:'+TreeLeftPosition+';margin-bottom: 50px;">');
  }
...
async function checkCollisions(){
  ...
  if (match) { 
    TreeRealBroken++;
    $("#character").attr('src', 'asserts/img/guy.gif');
    await sleep(1000);
    box.attr('src',
    'asserts/img/tree-broken.png'); 
    $("#character").attr('src', 'asserts/img/character_stand.png');
    s = parseInt(localStorage.getItem('score')); 
    if (s >= 1 ) {
      s -= 1;
      localStorage.setItem('score', s); 
...
async function character_move_func()
{
  if (FIRST_MOVE == 1) {
    ...
    $("#theCharacter").append(' <div id="tree_hater" style="margin-top:-350px;margin-bottom: 50px;margin-left:'+left+'px;margin-top:'+(offset.top - CharacterTop)+'px;" class="convas"><img src="asserts/img/character_stand.png" id="character" class="circle" style="">');
  ...
  //Tree broken
    ...
    $("#"+TreeBroken).attr('src','asserts/img/tree-broken.png'); 
    $("#character").attr('src', 'asserts/img/character_stand.png');
    s = parseInt(localStorage.getItem('score')); 
    if (s >= 1 ) {
      s -= 1;
...
function industryPlace()
{
  ...
  $("#trees").append('<img class="tree" src="asserts/img/factory.png" style="'+industryMargin+'">');
